...
description: Module creates a text file on the remote host at the path specified by the `path` parameter, with the content specified by the `content` parameter
